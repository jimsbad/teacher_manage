<template>
  ...
  <div style="padding: 10px">
    ...
    <el-table :data="tableData1" border style="width: 100%">
      ...
      <el-table-column prop="honor_level" label="获奖级别"/>
      <el-table-column prop="honor_ranking" label="获奖名次"/>
      <el-table-column prop="honor_date" label="获奖时间"/>
      <el-table-column prop="note" label="备注"/>
      <el-table-column prop="credential" label="佐证"/>
      <el-table-column prop="team_id" label="团队编号"/>
    ...
    <el-dialog title="提示" v-model="dialogVisible" width="40%">
      <el-form :model="form" label-width="120px">
        <el-form-item label="老师工号">
          <el-input v-model="form.teacher_id" style="width: 60%"></el-input>
        </el-form-item>
      </el-form>
      <el-form :model="form" label-width="120px">
        <el-form-item label="竞赛名称">
          <el-input v-model="form.competition_name" style="width: 60%"></el-input>
        </el-form-item>
      </el-form>
      <el-form :model="form" label-width="120px">
        <el-form-item label="项目名称">
          <el-input v-model="form.project_name" style="width: 60%"></el-input>
        </el-form-item>
      </el-form>
      <el-form :model="form" label-width="120px">
        <el-form-item label="比赛类型">
          <el-input v-model="form.competition_type" style="width: 60%"></el-input>
        </el-form-item>
      </el-form>
      <el-form :model="form" label-width="120px">
        <el-form-item label="获奖级别">
          <el-input v-model="form.honor_level" style="width: 60%"></el-input>
        </el-form-item>
      </el-form>
      <el-form :model="form" label-width="120px">
        <el-form-item label="获奖名次">
          <el-input v-model="form.honor_ranking" style="width: 60%"></el-input>
        </el-form-item>
      </el-form>
      <el-form :model="form" label-width="120px">
        <el-form-item label="获奖时间">
          <el-input v-model="form.honor_date" style="width: 60%"></el-input>
        </el-form-item>
      </el-form>
      <el-form :model="form" label-width="120px">
        <el-form-item label="备注">
          <el-input v-model="form.note" style="width: 60%"></el-input>
        </el-form-item>
      </el-form>
      <el-form :model="form" label-width="120px">
        <el-form-item label="佐证">
          <el-input v-model="form.credential" style="width: 60%"></el-input>
          <el-upload action="http://localhost:8080/compete/importPDF" :show-file-list="false"
      ...
      <el-form :model="form" label-width="120px">
        <el-form-item label="团队编号">
          <el-input v-model="form.team_id" style="width: 60%"></el-input>
        </el-form-item>
      </el-form>
      <!-- <el-form :model="form" label-width="120px">
        <el-form-item label="老师工号">
      ...
      <el-form :model="form" label-width="120px">
        <el-form-item label="学生列表">
          <el-input v-model="form.stu_message" style="width: 60%" ></el-input>
          <!-- <el-button type="primary">新增</el-button> -->
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    load() {
      axios.get("http://localhost:8080/compete/", {}).then(res => {
        console.log(res)
    ...
    post() {
      ...
      // axios.post("http://localhost:8080/compete/importExcel",{})
      let fd = new FormData();
      ...
      this.$axios.post('/http://localhost:8080/compete/importExcel', fd).then(res => {
...
// 确定
    save() {
      ...
      if (this.id !== 0) {
        axios.post("http://localhost:8080/compete/insert", this.form).then(res => {
          console.log(res)
          this.load()                   //更新数据
...
//删除
    ...
    exp() {
      window.open("http://localhost:8080/compete/download")
    },
    download() {
      window.open("http://localhost:8080/compete/downloadTemplate")
    },
