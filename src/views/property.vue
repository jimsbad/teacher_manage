<template>
  ...
  <div style="padding: 10px">
    ...
    <el-table :data="tableData1" border style="width: 100%">
      ...
      <el-table-column prop="intellectual_property_code" label="知识产权编号"/>
      <el-table-column prop="intellectual_property_name" label="知识产权名称"/>
      <el-table-column prop="publish_unit" label="发表单位"/>
      <el-table-column prop="publish_date" label="发表日期"/>
      <el-table-column prop="intellectual_property_type" label="知识产权类型"/>
    ...
    <el-dialog title="提示" v-model="dialogVisible" width="60%">
      <el-form :model="form" label-width="120px">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="知识产权编号">
              <el-input v-model="form.intellectual_property_code" style="width: 30%"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="知识产权名称">
              <el-input v-model="form.pintellectual_property_name" style="width: 30%"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="发表单位">
              <el-input v-model="form.publish_unit" style="width: 30%"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="发表日期">
              <el-input v-model="form.publish_date" style="width: 30%"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="知识产权类型">
              <el-input v-model="form.intellectual_property_type" style="width: 30%"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
...
export default {
  ...
  methods: {
    ...
    post() {
      ...
      // axios.post("http://localhost:8080/property/importExcel",{})
      let fd = new FormData();
      ...
      this.$axios.post('/http://localhost:8080/property/importExcel', fd).then(res => {
...
// 确定
    save() {
      ...
      if (this.id !== 0) {
        axios.post("http://localhost:8080/property/insert", this.form).then(res => {
          console.log(res)
          this.load()                   //更新数据
...
//删除
    ...
    exp() {
      window.open("http://localhost:8080/property/download")
    },
    download() {
      window.open("http://localhost:8080/property/downloadTemplate")
    },
